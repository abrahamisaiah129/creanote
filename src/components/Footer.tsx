      ...
      <div className="footer-inner">
        <div className="footer-main-row">
          <div className="footer-left-col">
            <Link href="/" className="footer-logo-link" aria-label="Creanote Home">
        ...
        <div className="footer-msg">
          If you have questions, want to share your journey with us, feedback, or simply want to
          <br />
        ...
        <div className="footer-tag">...notes from the creative journey</div>
      </div>
    </footer>
  );
};
